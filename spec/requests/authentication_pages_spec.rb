...
describe "Authentication" do
  ...
  describe  "authorization" do
    ...
    describe  "for non-signed-in users" do 
      ...
      describe "when attempting to visit a proctect page" do 
        before do 
        ...
        describe "after signing in" do 
          it "should render the desired proctect page" do 
      ...
      describe "in the users controller" do 
        ...
        describe "sumbitting to the update action" do 
        ...
        describe "as wrong user" do 
          ...
          describe "sumbitting to the put request" do 
